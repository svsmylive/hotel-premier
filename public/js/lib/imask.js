(function (global, factory) {
  ...
  class HTMLMaskElement extends MaskElement {
    ...
    _onKeydown(e) {
      if (
        this._handlers.redo &&
        ((e.keyCode === KEY_Z && e.shiftKey && (e.metaKey || e.ctrlKey)) || (e.keyCode === KEY_Y && e.ctrlKey))
      ) {
        e.preventDefault();
  ...
  class RepeatBlock extends MaskedPattern {
    get repeatFrom() {
      var _ref;
      return (_ref = Array.isArray(this.repeat) ? this.repeat[0] : this.repeat === Infinity ? 0 : this.repeat) != null
        ? _ref
        : 0;
    }
    get repeatTo() {
    ...
    _update(opts) {
      ...
      this.repeat =
        (_ref3 = (_ref4 = repeat != null ? repeat : block.repeat) != null ? _ref4 : this.repeat) != null ? _ref3 : Infinity; // TODO type
